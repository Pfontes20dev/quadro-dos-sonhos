/*
[x] Saber quem são os elementos da tela
[x] Quando o botão foi clicado
[x] Pegar as informações dos inputs
[x] Criar o card 
[x] Mostrar o card na tela
[x] Remover o card ao clicar no botão
[x] Alterar o status do sonho
[x] Salvar os cards para quando o usuário fecha a janela
*/
...
/* EVENTO DO FORMULÁRIO (ADICIONAR) */
